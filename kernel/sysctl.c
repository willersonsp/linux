...
static int min_task_running_granularity = 5;		/* 5 ms */
static int max_task_running_granularity = 500;		/* 500 ms */
#endif
...
#ifdef CONFIG_IAS_SESSION
	{
		.procname	= "session_task_running_limit",
		.data		= &session_task_running_limit,
		.maxlen		= sizeof(int),
		.mode		= 0644,
		.proc_handler	= proc_dointvec_minmax,
		.extra1		= &min_task_running_granularity,
		.extra2		= &max_task_running_granularity,
	},
#endif
