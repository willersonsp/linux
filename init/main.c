...
static void boot_timestamp_print(void)
{
	void __iomem *base;
	unsigned int i;
	unsigned int value;
...
#ifdef CONFIG_VENDOR_TIMER_TRIGGER_RCU
/* fast rcu */
