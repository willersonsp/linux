 ...
 *
 * Hi3516CV300 clock IDs — kept aligned with the vendor BSP so its
 * 3.18-era DT (arch/arm/boot/dts/hisilicon/hi3516cv300{.dtsi,-demb.dts})
 * compiles unchanged against the modern crg-hi3516cv300.c driver.
 */
