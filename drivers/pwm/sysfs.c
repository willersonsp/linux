...
#ifdef CONFIG_ARCH_BSP
	if (((chip->base == PWM_BASE_0) && (pwm->hwpwm == PWM_COMPLEMENTARY_CHN_0 || pwm->hwpwm == PWM_COMPLEMENTARY_CHN_3 ||
			pwm->hwpwm == PWM_COMPLEMENTARY_CHN_4 || pwm->hwpwm == PWM_COMPLEMENTARY_CHN_5)) ||
		((chip->base == PWM_BASE_6) && (pwm->hwpwm == PWM_COMPLEMENTARY_CHN_0 || pwm->hwpwm == PWM_COMPLEMENTARY_CHN_4 ||
			pwm->hwpwm == PWM_COMPLEMENTARY_CHN_5))
		) {
